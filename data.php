...
<h3 style="margin:10px;">Input the data</h3>
  <form action="" method="POST" align="center" style="border-radius: 10px;">
  <label>Department:</label><br>
  <input type="text" name="dept" id="dept" required><br>
  <label>Number of Doctors available:</label><br>
  <input type="number" name="docavail" id="doc" required><br>
  <button type="submit" name="submit" class="btn">Submit</button>
   ...
   if(isset($_POST['submit']))
   {
       ...
       $query = "INSERT INTO `data` (`department`,`doctorsavailable`) VALUES('$dept','$doc')";

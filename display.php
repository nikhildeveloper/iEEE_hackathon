  ...
  <table class="table">
      ...
      session_start();
          ...
          while($row = mysqli_fetch_array($query_run))
          {
              ?>
              <tr>
              <td style="font-weight: bold;"> <?php echo $row['department'] ?></td>
              <td style="font-weight: bold;"> <?php echo $row['doctorsavailable'] ?></td>
              ...
              <td><a href="appointment.php"><button name="book"class="btn" id="button">Book</button></a></td>
              </tr>              
              <?php
          }
      ?>

...
<html lang="en">
  ...
  <div class="container" align="center">
      <h2 style="text-align: center;">General-info Input form</h2>
      <form action="" method="POST" align="center">
          <label>Number of beds available:</label>
          <input type="number" id="bed" name="bed" required>
          <label>Number of oxygen beds available:</label>
          <input type="number" id="obed" name="obed" required>
          <label>Number of non-oxygen beds available</label>
          <input type="number" id="nbed" name="nbed" required>
          <label>Number of ICU beds available</label>
          <input type="number" id="icu" name="icu" required><br>
   ...
   if(isset($_POST['submit']))
   {
       ...
       $query = "INSERT INTO `general`(`bed`,`obed`,`nbed`,`icu`) VALUES('$bed','$obed','$nbed','$icu')";
       $query_run = mysqli_query($con,$query);

       if($query_run)
       {
           echo '<script type="text/javascript"> alert("Data inserted")</script>';
           header('location: information_visible.php');
       }
       else
       {

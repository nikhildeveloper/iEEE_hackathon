...
<html lang="en">
  ...
  <div class="container" align="center" style="margin-bottom: 200px; margin-top: 100px;">
      <h2 style="text-align: center;">Ambulance info Input form</h2>
      <form action="" method="POST" align="center">
          <label>Ambulance Driver Name:</label><br>
          <input type="text" id="ambu" name="driver" required><br>
          <label>Ambulance Driver Contact</label><br>
   ...
   if(isset($_POST['submit']))
   {
       ...
       $query = "INSERT INTO `ambulance`(`driver`,`contact`) VALUES('$driver','$contact')";
